...
(function () {
  ...
  var CATS = [
    ...
    { key: 'community',     num: '03', label: 'Community Impact',      sub: 'Numbers that don\'t need a trophy — people screened, kilos moved, lives touched.',                                color: '#db2777',
    ...
    { key: 'research',      num: '04', label: 'Research Publications', sub: 'Accepted abstracts, papers and journal credits written by students who started at KMC.',                          color: '#6d28d9',
    ...
    { key: 'international', num: '05', label: 'International Recognition', sub: 'Peshawar carried onto the world stage — assemblies, national teams and global seats.',                      color: '#1d4ed8',
      icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>' },
    { key: 'national',      num: '06', label: 'National Partnerships', sub: 'The MoUs and collaborations that turn council work into lasting, joined-up impact.',                             color: '#0d9488',
